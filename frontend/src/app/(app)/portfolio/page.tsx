...
export default function PortfolioPage() {
  ...
  return (
    <div className="p-6 sm:p-10 max-w-7xl mx-auto w-full space-y-8">
      ...
      <Card className="border-primary-500/30 bg-gradient-to-r from-surface-dark via-surface-dark to-night">
        <CardContent className="p-6 sm:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-slate-400 text-xs sm:text-sm max-w-xl font-body leading-relaxed">
      ...
      {isEditingProfile && (
        <Card className="animate-slide-up border-primary-500/40">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="sm:col-span-2 space-y-1">
                <label className="text-xs font-medium text-slate-300">Short biography</label>
                <textarea
                  rows={3}
      ...
      {submissions?.length === 0 ? (
        <Card className="p-12 text-center flex flex-col items-center space-y-3">
          <Code2 className="w-12 h-12 text-slate-600 mb-1" />
